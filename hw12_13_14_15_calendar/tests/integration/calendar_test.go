...
import (
	...
	calendar "github.com/koind/avito_otus_hw/hw12_13_14_15_calendar/api/protoc"
	"github.com/koind/avito_otus_hw/hw12_13_14_15_calendar/util"

	sqlcstorage "github.com/koind/avito_otus_hw/hw12_13_14_15_calendar/internal/storage/sql/sqlc"
...
func (s *CalendarSuite) SetupSuite() {
	...
	if storageSource == "" {
		storageSource = "postgres://calendar:postgres@localhost:5432/calendar?sslmode=disable"
	}
